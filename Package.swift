...
let package = Package(
    ...
    targets: [
        ...
        .target(
            ...
            cxxSettings: [
                .headerSearchPath("."),
                // Platform (CMakeLists.txt:540 — non-Windows)
                .define("ROCKSDB_PLATFORM_POSIX"),
                .define("ROCKSDB_LIB_IO_POSIX"),
                // OS (CMakeLists.txt:513-515)
                .define("OS_MACOSX"),
                .define("IOS_CROSS_COMPILE", .when(platforms: [.iOS])),
                // Portability
                .define("PORTABLE"),
                // macOS/iOS capabilities (F_FULLFSYNC exists on Apple platforms)
        ...
        .target(
            name: "rocksdb-generated",
            dependencies: ["rocksdb"],
            path: "Sources/rocksdb-generated",
            sources: ["build_version.cc"],
            publicHeadersPath: "include",
            cxxSettings: [
                .define("ROCKSDB_PLATFORM_POSIX"),
                .define("OS_MACOSX"),
